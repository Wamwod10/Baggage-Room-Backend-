...
router.post("/", validate(z.object({ body: z.object({ branchId: z.string().optional(), receiverName: z.string().trim().min(2), amount, currency: currency.default("UZS"), note: z.string().optional() }) })), inkassaController.create);
