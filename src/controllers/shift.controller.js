...
const operatorStats = asyncHandler(async (req, res) => success(res, await shiftService.currentOperatorStats(req.user, req.query)));
...
module.exports = { list, current, operatorStats, sendCurrentSalesTelegram, open, close };
